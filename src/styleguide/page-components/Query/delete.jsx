    ...
    onSubmit: async (values) => {
      try {
        ...
        let response = await fetch('/api/tweet', {
          ...
          body: JSON.stringify({ tweet_id: values.tweet_id }),
        });
        ...
        if (response.status === 500) {
          ...
          addNotification({
            color: 'success',
            message: 'Successfully Delete Tweet with ID' + tweet_id,
          });
        ...
        <GridItem xs={12} sm={12} md={10}>
          <Card>
            <CardHeader color="warning">
              <h4 className={classes.cardTitleWhite}>Delete Tweet</h4>
            </CardHeader>
            <CardBody>
              <GridContainer>
                ...
                <GridContainer>
                  <Card>
                    <CardHeader color="rose">
                      <h4 className={classes.cardTitleWhite}>Deleted Tweet by: {tweet.writer}</h4>
                    </CardHeader>
                    <CardBody>
                      <GridContainer>
                        <GridItem xs={12} sm={12} md={12}>
